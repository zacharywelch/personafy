...
module.exports = function(defaults) {
  ...
  app.import('vendor/avatars/fizzy.jpg',          { destDir: 'avatars' });
  app.import('vendor/avatars/ben10.jpg',          { destDir: 'avatars' });
  app.import('vendor/avatars/cyberchase.jpg',     { destDir: 'avatars' });
  app.import('vendor/avatars/adventuretime.jpg',  { destDir: 'avatars' });
  app.import('vendor/avatars/bloo.jpg',           { destDir: 'avatars' });
  app.import('vendor/avatars/fusionfall.jpg',     { destDir: 'avatars' });
  app.import('vendor/avatars/gumball.jpg',        { destDir: 'avatars' });
  app.import('vendor/avatars/wordgirl.jpg',       { destDir: 'avatars' });
  app.import('vendor/avatars/rigby.jpg',          { destDir: 'avatars' });
  app.import('vendor/avatars/pokemon.jpg',        { destDir: 'avatars' });
  app.import('vendor/avatars/super-why.jpg',      { destDir: 'avatars' });
