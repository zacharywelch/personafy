...
module.exports = function(defaults) {
  ...
  app.import('vendor/avatars/batman.jpg',     { destDir: 'avatars' });
  app.import('vendor/avatars/bloo.jpg',       { destDir: 'avatars' });
  app.import('vendor/avatars/chowder.jpg',    { destDir: 'avatars' });
  app.import('vendor/avatars/dexter.jpg',     { destDir: 'avatars' });
  app.import('vendor/avatars/finn.jpg',       { destDir: 'avatars' });
  app.import('vendor/avatars/hero.jpg',       { destDir: 'avatars' });
  app.import('vendor/avatars/kai.jpg',        { destDir: 'avatars' });
  app.import('vendor/avatars/pokemon.jpg',    { destDir: 'avatars' });
  app.import('vendor/avatars/rigby.jpg',      { destDir: 'avatars' });
  app.import('vendor/avatars/steven.jpg',     { destDir: 'avatars' });
  app.import('vendor/avatars/toothless.jpg',  { destDir: 'avatars' });
  app.import('vendor/avatars/ben10.jpg',      { destDir: 'avatars' });
  app.import('vendor/avatars/chima.jpg',      { destDir: 'avatars' });
  app.import('vendor/avatars/clarence.jpg',   { destDir: 'avatars' });
  app.import('vendor/avatars/ed.jpg',         { destDir: 'avatars' });
  app.import('vendor/avatars/gumball.jpg',    { destDir: 'avatars' });
  app.import('vendor/avatars/jtest.jpg',      { destDir: 'avatars' });
  app.import('vendor/avatars/mordecai.jpg',   { destDir: 'avatars' });
  app.import('vendor/avatars/powerpuff.jpg',  { destDir: 'avatars' });
